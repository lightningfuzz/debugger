 ...
 *
 * Consider the following sequence of events for Symboltable t:
 * t.put(Symbol("a"),5)
 * t.beginScope()
 * t.put(Symbol("b"),7)
 * t.put(Symbol("a"),9)
...
*/
 ...
 /**
  * Removes the last "amount" (number) of symbols added to the SymbolTable
  */
...
//	marks=marks.getTail();
  ...
  /**
   * Used for printing the Symbols and their values
   * @return String str
   */
  public String toString(){
      ...
      for(String key : symbols.keySet()){
          str += key + "/" + (symbols.get(key)).getValue() + ",";
      }
